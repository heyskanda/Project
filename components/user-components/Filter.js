...
export const Filter = ({isOpen}) => {
  return (
    <>
        <details open={isOpen} className={ isOpen ? "absolute z-10 bg-night overflow-hidden w-[30%] rounded border translate-x-[170%]  text-light-blue mt-4" : "hidden"}>
            ...
            <fieldset>
                <legend className="block w-full px-5 py-3 text-xs font-medium bg-night-light border-b">
                Type
                </legend>
            ...
            <div>
                <fieldset>
                <legend className="block w-full px-5 py-3 text-xs font-medium bg-night border-y">
                    Age
                </legend>
                <div className="px-5 py-6 space-y-2">
                    <div className="flex items-center">
