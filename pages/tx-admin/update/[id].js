...
export default function Id() {
	...
	const { fetchSingleIdea, singleIdea, consolidatedInvestmentDocument, consolidatedDocument } = useAuth()
	...
	const handleUpdateIdea = (e) => {
		...
		try{
			...
			console.log(error)
			toast.error('Idea could not be altered')
		}
	}
	...
	const handleDeleteDocument = async(e) => {
		...
		try{
			...
			await updateDoc(consolidatedDocRef, {
  	...
  	return (
		...
		<div className="w-[90%] float-right bg-gradient-to-br from-slate-900 to-gray-900 flex flex-col py-10 pl-10 pr-24 h-full">
			...
			<form 
				...
				<a
					className="col-span-3 cursor-pointer text-white text-base bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg w-full sm:w-auto px-12 py-2.5 text-center dark:bg-red-700 dark:hover:bg-red-800 dark:focus:ring-red-800"
